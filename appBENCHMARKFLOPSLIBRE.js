...
app.get("/api/benchmark/flops-libre", async (req, res) => {
  res.json(await flopsLibreBenchmark({size: req.query.size, rounds: req.query.rounds}));
});
